...
sr.reveal(`.home-info h1, .featured-container, .popular-container, .car-group .title, .car-filters`);
sr.reveal(`.home-info h2`, { delay: 500 });
sr.reveal(`.home-info h3`, { delay: 600 });
sr.reveal(`.home-content`, { delay: 800, interval: 100, origin: "bottom" });
sr.reveal(`.home-button`, { delay: 900, origin: "bottom" });
sr.reveal(`.car-card, .brand-content, .footer-content`, { delay: 100 });
sr.reveal(`.about-group, .offer-info`, { origin: "left" });
sr.reveal(`.about-info, .offer-img`, { origin: "right" });
